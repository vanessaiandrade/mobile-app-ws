...
public class AmazonSES {
	...
	final String FROM = "vanessaiandrade.dev@gmail.com";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://ec2-15-188-62-180.eu-west-3.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://ec2-15-188-62-180.eu-west-3.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
